...
public class Configuration {
	...
	// System
	public static final int STEPS = 1500000; //total number of steps
	public static final int MIN_THRESH_STEPS = 500000; //number of steps before values are recorded
	public static final double ligandDC = 9.0; // ligand dc. EDT: 2.0. Alumina: 9.0.
	public static final double npDC = 22.0; //bulk dielectric constant
	public static final double ligandLength = 0.2 ; // in nm
	...
	public static final double latticeAngleGamma = 96.0*Math.PI/180.0; //lattice basis angle in radians
	public static final double latticeAngleAlpha = 103.0*Math.PI/180.0; //lattice basis angle in radians
	public static final double latticeAngleBeta = 95.0*Math.PI/180.0; //lattice basis angle in radians
	public static final String latticeStructure = "triclinic"; //"triclinic" or "cubic"
	public static final double latticeBasisLength = 6.62; //in nm
	...
	// NP
	public static final double distThr = 1.27; //was 1.27
	//public static final double distThr = 4.5; //in nm, for triclinic
	//public static final double distThr = 6.0; //in nm, for cubic
